                ...
                for (const link of links) {
                    try {
                        ...
                        if (hasKeyword &&
                            ...
                            const id = `okx-${Buffer.from(`${title}-${fullUrl}`).toString("base64")}`;
                            ...
                            if (!isDuplicate) {
                                ...
                                console.log(`Added OKX announcement: "${title.substring(0, 50)}..."`);
                            }
                        }
                    }
                    catch (err) {
                ...
                for (const selector of possibleSelectors) {
                    ...
                    for (const element of elements) {
                        try {
                            ...
                            if (!title || title.length < 10) {
                                const titleElement = element.querySelector("h3, h2, strong, b, span, a");
                                if (titleElement) {
                            ...
                            if (hasKeyword &&
                                ...
                                if (!isDuplicate) {
                                    ...
                                    console.log(`Added OKX announcement from ${selector}: "${title.substring(0, 50)}..."`);
                                }
                            }
                        }
                        catch (err) {
